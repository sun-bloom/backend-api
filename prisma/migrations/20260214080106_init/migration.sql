...
CREATE TABLE "DeliverySettings" (
    ...
    "defaultShippingCharge" DOUBLE PRECISION NOT NULL DEFAULT 50,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "DeliveryRegion_pincode_key" ON "DeliveryRegion"("pincode");
...
-- AddForeignKey
ALTER TABLE "DeliveryRegion" ADD CONSTRAINT "DeliveryRegion_deliverySettingsId_fkey" FOREIGN KEY ("deliverySettingsId") REFERENCES "DeliverySettings"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
